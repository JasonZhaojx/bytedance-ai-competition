...
SIMULATED_RESPONSE_COUNT = int(os.getenv("SIMULATED_RESPONSE_COUNT", "50"))
...
def analyze_response_files(
    ...
    code_analysis = build_code_analysis(questionnaire_items, responses)
    analysis_markdown = analyze_survey_with_llm(product_description, questionnaire_items, responses)
...
def main() -> None:
    ...
    analysis_markdown = analyze_survey_with_llm(product_description, items, responses)
